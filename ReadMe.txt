...
$ python script.py  <L> <K> <training-set> <validation-set> <test-set> <to-print>

Examples for reference:
To output without printing trees, with L and K both 10:
$ python script.py 10 10 "D://MS//training_set.csv" "D://MS//validation_set.csv" "D://MS//test_set.csv" "no"

To print the tree (with L and K both set to 10) command is 
$ python script.py 10 10 "D://MS//training_set.csv" "D://MS//validation_set.csv" "D://MS//test_set.csv" "yes"
